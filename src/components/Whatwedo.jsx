...
import WarehouseImage from "../assets/WarehouseImage.jpeg";
...
const services = [
  ...
  },
  {
    ...
    description:
      "Our warehouse construction services cover the complete scope—from site preparation, foundation laying, structural fabrication, roofing, and flooring, to electrical and civil work—ensuring robust, efficient, and future-ready facilities. We understand the importance of durability, space optimization, and timely execution, especially in industrial and logistics sectors.",
...
const WhatWeDo = () => {
  return (
    <section id="services" className="py-12 bg-white">
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-800 mb-1">What We Do</h2>
          <div className="w-16 h-1 bg-yellow-500"></div>
        </div>
